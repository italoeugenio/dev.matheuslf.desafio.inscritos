...
public class AdminAuthenticationService {
    ...
    public ResponseEntity<Void> register(RegisterAdminDTO data) throws BadRequestException {
        ...
        UserModel newUser = new UserModel(data.fullName(), data.email().toLowerCase(), encryptedPassword, data.role());
